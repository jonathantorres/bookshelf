...
void list_reverse_rec(list *_list);
int list_length(list *_list);

void list_reverse_node(list_node *cur_node, list_node **prev_node)
{
    if (!cur_node) {
        return;
    }
    ...
    *prev_node = cur_node;
    ...
    list_reverse_node(cur_node, prev_node);
}
...
int main(void)
{
    ...
    list *more_names = list_new();
    list_push(more_names, strdup("John 1"));
    list_push(more_names, strdup("John 2"));
    list_push(more_names, strdup("John 3"));
    list_push(more_names, strdup("John 4"));

    // reverse recursively
    LIST_FOREACH(more_names) {
        printf("- %s\n", (char*)cur->value);
    }
    puts("");
    list_reverse_rec(more_names);
    LIST_FOREACH(more_names) {
        printf("- %s\n", (char*)cur->value);
    }
    list_destroy(more_names);
