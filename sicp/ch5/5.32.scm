...
; machine with minor optimization in which operators that are symbols are handled differently
; the symbol is looked up in the environment and the call is made directly
(define ec-machine
  (make-machine
