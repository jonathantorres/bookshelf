...
; add new operations
(define ec-operations (append ec-operations (list
                                              (list 'compile-and-run compile-and-run)
                                              (list 'compile-and-run? compile-and-run?)
                                              (list 'compile-and-run-exp compile-and-run-exp))))

(define ec-machine-compile
  (make-machine
...
(set-register-contents! ec-machine-compile 'env the-global-environment)
(start ec-machine-compile)

; type the following into the evaluator:
