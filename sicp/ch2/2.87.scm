...
(display (=zero? (make-rational 0 5))) (newline)
(display (=zero? (make-rational 5 10))) (newline)
...
(define p3 (make-polynomial 'x (list (list 0 zero) (list 0 zero))))
(define p4 (make-polynomial 'x (list (list 0 p1))))

; test =zero? for polynomials
(display (=zero? p1)) (newline)
(display (=zero? p2)) (newline)
(display (=zero? p3)) (newline)
