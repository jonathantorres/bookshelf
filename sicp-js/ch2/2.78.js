import {
    pair, head, tail, display, display_list, list, math_cos, math_sin, is_pair, is_number, is_string,
    is_null, append, error, equal, length, is_undefined, set_tail, map, apply_in_underlying_javascript
} from 'sicp';
...
display(add(make_javascript_number(1), make_javascript_number(2)));
display(add(1, 2));
