...
// javascript numbers
display(is_equal_to_zero(make_javascript_number(0)));
display(is_equal_to_zero(make_javascript_number(1)));

// rational numbers
display(is_equal_to_zero(make_rational(0, 1)));
display(is_equal_to_zero(make_rational(3, 8)));

// complex numbers
display(is_equal_to_zero(make_complex_from_real_imag(0, 0)));
display(is_equal_to_zero(make_complex_from_real_imag(4, 3)));
...
function install_complex_package() {
    ...
    function is_equal_to_zero_complex(z) {
    ...
    put("is_equal_to_zero", list("complex"),
        (z) => tag(is_equal_to_zero_complex(z)));
