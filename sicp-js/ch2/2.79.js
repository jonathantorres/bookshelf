...
// javascript numbers
display(is_equal(make_javascript_number(1), make_javascript_number(1)));
display(is_equal(make_javascript_number(1), make_javascript_number(2)));

// rational numbers
display(is_equal(make_rational(1, 2), make_rational(1, 2)));
display(is_equal(make_rational(3, 8), make_rational(2, 4)));

// complex numbers
display(is_equal(make_complex_from_real_imag(4, 3), make_complex_from_real_imag(4, 3)));
display(is_equal(make_complex_from_real_imag(4, 3), make_complex_from_real_imag(8, 4)));
