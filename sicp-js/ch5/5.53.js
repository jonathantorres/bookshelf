// for now, take the evaluator as a string and compile it using compile_and_go
// need to test this a bit more further
const evaluator = compile_and_go(parse(`
...
const prog = "{ display(4) - display(1); }";
const tree = parse(prog);

evaluate(tree, the_global_environment);

function list_of_values(exps, env) {
    return list_of_values_left(exps, env);
}
