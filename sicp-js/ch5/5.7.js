...
// you can use this machine simulator as the base one for the exercises

// recursive exponentiation
const recursive_exp_machine = make_machine(
    list("continue", "n", "b", "val"),
    list(
        list("*", (a, b) => a * b),
        list("-", (a, b) => a - b),
        list("=", (a, b) => a === b),
...
set_register_contents(recursive_exp_machine, "b", 10);
set_register_contents(recursive_exp_machine, "n", 2);
start(recursive_exp_machine);
display(get_register_contents(recursive_exp_machine, "val"));

// iterative exponentiation
const iterative_exp_machine = make_machine(
...
set_register_contents(iterative_exp_machine, "b", 10);
set_register_contents(iterative_exp_machine, "n", 2);
start(iterative_exp_machine);
display(get_register_contents(iterative_exp_machine, "product"));
