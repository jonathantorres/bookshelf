...
display_instruction_count(exp_machine);

function display_instruction_count(machine) {
...
function make_new_machine() {
    ...
    function display_instruction_count() {
        display("instruction count is " + instruction_count);
        instruction_count = 0;
    }
