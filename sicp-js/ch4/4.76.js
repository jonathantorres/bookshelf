// query evaluator
import {
    display, pair, head, tail, is_null, error, list, append, parse, map, set_tail, is_string,
    math_PI, stringify, accumulate, is_pair, list_ref, length, set_head, equal, math_abs, char_at,
    apply_in_underlying_javascript, is_boolean, stream_map, is_undefined, stream_tail, math_E
} from 'sicp';
...
// add queries, rules or assertions to process
process_query(`
    assert(rule(append_to_form(null, $y, $y)))
`);
