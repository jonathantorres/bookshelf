...
function is_amb(component) {
    return (is_tagged_list(component, "application") &&
           ...
           symbol_of_name(conditional_predicate(component)) === "evaluation_succeeds_take";
}

function analyze_amb(component) {
    if (is_tagged_list(component, "conditional_statement")) {
        return (env, succeed, fail) => {
            const res = analyze(conditional_consequent(component));
            return res(env, succeed, () => conditional_alternative(component));
        };
    } else {
