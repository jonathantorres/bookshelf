...
// testing the while_loop function
display(fact(5), "fact(5) =");
function fact(n) {
    let product = 1;
    let counter = 1;
...
function evaluate(component, env) {
    return is_literal(component)
           ...
           ? eval_break(component, env)
           : is_continue_statement(component)
           ? eval_continue(component, env)
...
// evaluators and predicates for "break" and "continue"
function is_break_statement(component) {
   return is_tagged_list(component, "break_statement");
}

function eval_break(component, env) {
    return make_return_statement(make_literal("break"));
}
...
function eval_continue(component, env) {
    return make_return_statement(make_literal("continue"));
}
...
function make_return_statement(content) {
    return list("return_statement", content);
}
