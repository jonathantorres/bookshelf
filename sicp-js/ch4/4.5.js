...
const prog = "{ const f = (a,b) => { display(a); display(b); return 'ok'; }; f(1,2); }";
...
function lambda_parameter_symbols(component) {
    const symbols = map(symbol_of_name, head(tail(component)));
    return verify_lambda(symbols) ? symbols : error(symbols, "invalid lambda expression");
}

function verify_lambda(symbols) {
    let valid = true;
